...
describe("SemanticReleaseModuleService Branch Coverage", () => {
	...
	describe("getDevelopBranch", () => {
		...
		it("should use specific develop branch from config when available", async () => {
			...
			expect(mockCliInterfaceService.text).toHaveBeenCalledWith("Enter the name of your development branch for backmerge:", "dev", "development", expect.any(Function));
		});
	...
	describe("getMainBranch", () => {
		...
		it("should use specific main branch from config when available", async () => {
			...
			expect(mockCliInterfaceService.text).toHaveBeenCalledWith("Enter the name of your main release branch:", "main", "master", expect.any(Function));
		});
	...
	describe("getPreReleaseBranch", () => {
		...
		it("should use specific pre-release branch from config when available", async () => {
			...
			expect(mockCliInterfaceService.text).toHaveBeenCalledWith("Enter the name of your pre-release branch:", "dev", "develop", expect.any(Function));
		});
	...
	describe("getPreReleaseChannel", () => {
		...
		it("should use specific pre-release channel from config when available", async () => {
			...
			expect(mockCliInterfaceService.text).toHaveBeenCalledWith("Enter the pre-release channel name (e.g., beta, alpha, next):", "beta", "alpha", expect.any(Function));
		});
