...
import { PRETTIER_CONFIG_FILE_NAMES } from '../../../../src/application/constant/prettier-config-file-names.constant';
...
describe("PrettierModuleService Branch Coverage", () => {
  ...
  describe("handleExistingSetup", () => {
    ...
    it("should handle when user declines to delete existing files", async () => {
      ...
      expect(mockCliInterfaceService.warn).toHaveBeenCalledWith("Existing Prettier configuration files detected. Setup aborted.");
