...
describe('FRAMEWORK_CONFIG', () => {
  ...
  it('should handle frameworks with watchable configurations', () => {
    ...
    const watchableFrameworks = Object.values(FRAMEWORK_CONFIG).filter(
      config => config.isSupportWatch === true
    );
  ...
  it('should thoroughly test frameworks with specific line targets for coverage', () => {
    ...
    const testingFrameworks = [
      FRAMEWORK_CONFIG[EFramework.BABEL],
      FRAMEWORK_CONFIG[EFramework.BACKBONE],
      FRAMEWORK_CONFIG[EFramework.BLITZ],
      FRAMEWORK_CONFIG[EFramework.CHAKRA_UI]
    ];
  ...
  it('should test most framework configurations for 100% coverage', () => {
    ...
    const frameworksWithUndefinedIndicators = [
      EFramework.APOLLO,
      EFramework.DRIZZLE,
      EFramework.GRAPHQL,
      EFramework.JOTAI,
