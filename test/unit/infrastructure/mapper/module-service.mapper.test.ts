...
describe('ModuleServiceMapper', () => {
  ...
  describe('getModuleService', () => {
    it('should return CiModuleService for CI module', () => {
      ...
      expect(CiModuleService).toHaveBeenCalledWith(
    ...
    it('should return CommitlintModuleService for COMMITLINT module', () => {
      ...
      expect(CommitlintModuleService).toHaveBeenCalledWith(
        mockCliInterfaceService,
        mockFileSystemService,
        expect.anything()
      );
    ...
    it('should return EslintModuleService for ESLINT module', () => {
      ...
      expect(EslintModuleService).toHaveBeenCalledWith(
        mockCliInterfaceService,
        mockFileSystemService,
        expect.anything()
      );
    ...
    it('should return GitignoreModuleService for GITIGNORE module', () => {
      ...
      expect(GitignoreModuleService).toHaveBeenCalledWith(
        mockCliInterfaceService,
        mockFileSystemService,
        expect.anything()
      );
    ...
    it('should return IdeModuleService for IDE module', () => {
      ...
      expect(IdeModuleService).toHaveBeenCalledWith(
        mockCliInterfaceService,
        mockFileSystemService,
        expect.anything()
      );
    ...
    it('should return LicenseModuleService for LICENSE module', () => {
      ...
      expect(LicenseModuleService).toHaveBeenCalledWith(
        mockCliInterfaceService,
        mockFileSystemService,
        expect.anything()
      );
    ...
    it('should return LintStagedModuleService for LINT_STAGED module', () => {
      ...
      expect(LintStagedModuleService).toHaveBeenCalledWith(
        mockCliInterfaceService,
        mockFileSystemService,
        expect.anything()
      );
    ...
    it('should return PrettierModuleService for PRETTIER module', () => {
      ...
      expect(PrettierModuleService).toHaveBeenCalledWith(
        mockCliInterfaceService,
        mockFileSystemService,
        expect.anything()
      );
    ...
    it('should return SemanticReleaseModuleService for SEMANTIC_RELEASE module', () => {
      ...
      expect(SemanticReleaseModuleService).toHaveBeenCalledWith(
        mockCliInterfaceService,
        mockFileSystemService,
        expect.anything()
      );
    ...
    it('should return StylelintModuleService for STYLELINT module', () => {
      ...
      expect(StylelintModuleService).toHaveBeenCalledWith(
        mockCliInterfaceService,
        mockFileSystemService,
        expect.anything()
      );
    ...
    it('should throw an error for unsupported module', () => {
      ...
      expect(() => moduleServiceMapper.getModuleService(unsupportedModule)).toThrow(
        `Module ${unsupportedModule} is not supported`
      );
    });
  });
});