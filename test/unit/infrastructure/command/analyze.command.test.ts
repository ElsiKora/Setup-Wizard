...
describe("AnalyzeCommand", () => {
	...
	beforeEach(() => {
		...
		analyzeCommand = new AnalyzeCommand(propertiesMock, cliInterfaceServiceMock, fileSystemServiceMock);
	});
	...
	it("should clear the console and confirm analysis when executed", async () => {
		...
		expect(cliInterfaceServiceMock.confirm).toHaveBeenCalledWith("Do you want to analyze the project?");
	});
