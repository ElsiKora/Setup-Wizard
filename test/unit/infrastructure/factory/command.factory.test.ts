...
describe("CommandFactory", () => {
	...
	beforeEach(() => {
		...
		commandFactory = new CommandFactory(mockCliInterfaceService as any, mockFileSystemService as any);
	});
	...
	describe("createCommand", () => {
		it("should create an AnalyzeCommand when ANALYZE command type is provided", () => {
			...
			expect(AnalyzeCommand).toHaveBeenCalledWith(mockOptions, mockCliInterfaceService, mockFileSystemService);
		});
		...
		it("should create an InitCommand when INIT command type is provided", () => {
			...
			expect(InitCommand).toHaveBeenCalledWith(mockOptions, mockCliInterfaceService, mockFileSystemService);
		});
		...
		it("should throw an error for unknown command types", () => {
			...
			expect(() => commandFactory.createCommand(invalidCommand, mockOptions)).toThrow("Unknown command");
		});
	});
});
